    ...
    <div className="hidden lg:block relative" ref={dropdownRef}>
      ...
      >
        <svg
          ...
          className={`svg-inline--fa fa-circle-user text-xl transition-colors ${
            isOpen
              ? "text-primary-600"
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-64 bg-white border border-gray-100 rounded-2xl shadow-xl transition-all duration-200 origin-top-right z-50">
